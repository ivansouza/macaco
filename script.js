(function() {
  ...
  var svgEl = document.getElementById('monkey-svg');
  var svg = null;
  
  function getSvg() {
    if (svgEl.contentDocument) {
      return svgEl.contentDocument.querySelector('svg');
    }
    return canvas.querySelector('svg');
  }
  
  function qs(id) { return svg ? svg.querySelector('[id="' + id + '"]') : null; }
